...
public class Keys {
    ...
    public static final UniqueKey<QueueIncomingMessageRecord> KEY_QUEUE_INCOMING_MESSAGE_PRIMARY = Internal.createUniqueKey(QueueIncomingMessage.QUEUE_INCOMING_MESSAGE, DSL.name("KEY_queue_incoming_message_PRIMARY"), new TableField[] { QueueIncomingMessage.QUEUE_INCOMING_MESSAGE.ID }, true);
    public static final UniqueKey<QueueIncomingMessageRecord> KEY_QUEUE_INCOMING_MESSAGE_UC_QUEUE_INCOMING_MESSAGEREFERENCE_COL = Internal.createUniqueKey(QueueIncomingMessage.QUEUE_INCOMING_MESSAGE, DSL.name("KEY_queue_incoming_message_UC_QUEUE_INCOMING_MESSAGEREFERENCE_COL"), new TableField[] { QueueIncomingMessage.QUEUE_INCOMING_MESSAGE.REFERENCE }, true);
    public static final UniqueKey<QueueOutgoingMessageRecord> KEY_QUEUE_OUTGOING_MESSAGE_PRIMARY = Internal.createUniqueKey(QueueOutgoingMessage.QUEUE_OUTGOING_MESSAGE, DSL.name("KEY_queue_outgoing_message_PRIMARY"), new TableField[] { QueueOutgoingMessage.QUEUE_OUTGOING_MESSAGE.ID }, true);
    public static final UniqueKey<QueueOutgoingMessageRecord> KEY_QUEUE_OUTGOING_MESSAGE_UC_QUEUE_OUTGOING_MESSAGEREFERENCE_COL = Internal.createUniqueKey(QueueOutgoingMessage.QUEUE_OUTGOING_MESSAGE, DSL.name("KEY_queue_outgoing_message_UC_QUEUE_OUTGOING_MESSAGEREFERENCE_COL"), new TableField[] { QueueOutgoingMessage.QUEUE_OUTGOING_MESSAGE.REFERENCE }, true);
    ...
    public static final UniqueKey<ShedlockRecord> KEY_SHEDLOCK_PRIMARY = Internal.createUniqueKey(Shedlock.SHEDLOCK, DSL.name("KEY_shedlock_PRIMARY"), new TableField[] { Shedlock.SHEDLOCK.NAME }, true);
