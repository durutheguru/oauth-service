...
import com.julianduru.oauthservice.jooq.tables.records.DatabasechangelogRecord;
...
public class Databasechangelog extends TableImpl<DatabasechangelogRecord> {
    ...
    /**
     * The reference instance of <code>oauth_service.DATABASECHANGELOG</code>
     */
    ...
    /**
     * The column <code>oauth_service.DATABASECHANGELOG.ID</code>.
     */
    ...
    /**
     * The column <code>oauth_service.DATABASECHANGELOG.AUTHOR</code>.
     */
    ...
    /**
     * The column <code>oauth_service.DATABASECHANGELOG.FILENAME</code>.
     */
    ...
    /**
     * The column <code>oauth_service.DATABASECHANGELOG.DATEEXECUTED</code>.
     */
    ...
    /**
     * The column <code>oauth_service.DATABASECHANGELOG.ORDEREXECUTED</code>.
     */
    ...
    /**
     * The column <code>oauth_service.DATABASECHANGELOG.EXECTYPE</code>.
     */
    ...
    /**
     * The column <code>oauth_service.DATABASECHANGELOG.MD5SUM</code>.
     */
    public final TableField<DatabasechangelogRecord, String> MD5SUM = createField(DSL.name("MD5SUM"), SQLDataType.VARCHAR(35), this, "");

    /**
     * The column <code>oauth_service.DATABASECHANGELOG.DESCRIPTION</code>.
     */
    ...
    /**
     * The column <code>oauth_service.DATABASECHANGELOG.COMMENTS</code>.
     */
    ...
    /**
     * The column <code>oauth_service.DATABASECHANGELOG.TAG</code>.
     */
    public final TableField<DatabasechangelogRecord, String> TAG = createField(DSL.name("TAG"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>oauth_service.DATABASECHANGELOG.LIQUIBASE</code>.
     */
    ...
    /**
     * The column <code>oauth_service.DATABASECHANGELOG.CONTEXTS</code>.
     */
    ...
    /**
     * The column <code>oauth_service.DATABASECHANGELOG.LABELS</code>.
     */
    public final TableField<DatabasechangelogRecord, String> LABELS = createField(DSL.name("LABELS"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>oauth_service.DATABASECHANGELOG.DEPLOYMENT_ID</code>.
     */
    ...
    /**
     * Create an aliased <code>oauth_service.DATABASECHANGELOG</code> table reference
     */
    ...
    /**
     * Create a <code>oauth_service.DATABASECHANGELOG</code> table reference
     */
